...
| --- | --- | --- | --- | --- | --- | --- |
| 💊 약통 무게 복약 | **2.0** | 2.0 | 2.5 | 2.0 | 1.5 | 높음 |
| 🧠 객체 인식 사용주기(폰) | **3.5** | 3.5 | 1.0 | 2.5 | 3.0 | 보통~높음 |
...
- **가성비 최고 (취준용)** → 💊 **약통 무게 복약**
    ...
    하드웨어 간단, 지표 명확, 데모 임팩트 충분
    
- **AI 존재감 강조** → 🧠 **객체 인식 사용주기**
    
    비전 + Re-ID + 간단 예측까지 보여줄 수 있음
...
- 💊 **약통 무게 복약**
    - 1차: EWMA+피크검출 규칙형
    - 2차: 1D CNN으로 오탐(뚜껑 열림/진동) 제거
- 🧠 **객체 인식 사용주기**
    - YOLO-n + MobileCLIP 임베딩 + FAISS
    - 주기는 중앙값+EMA 먼저, 생존분석은 후순위
